...
Watcher.prototype = {
    ...
    onmessage : function (msg, rinfo, wmetric) {
        ...
        if (info.status.health_status_timestamp && changeInHealth &&
            info.status.health_is_down !== this.overall_health_is_down) {
    ...
    postDelete : function (pid) {
        ...
        if (this.overall_health_is_down && !this.isAnyWorkerDown()) {
